...
data_input <- 
  read_parquet(
    str_c(data_path, "1_intermediates", "phpdfs", "7_pre_aggregation",
          "county_total_data_ready_for_aggregation_2025-04-14.parquet",
    sep = "/"
  ))
...
write_csv(aggregated_suppressed,
          str_c(Sys.getenv("LOCAL_PATH"),
                ...
                "outputs",
                "aggregation_outputs",
                str_c("county_total_aggregated_", Sys.Date(),".csv"),
                sep = "/"))
...
write_csv(aggregated_initial,
          str_c(data_path,
                ...
                "phpdfs",
                "8_aggregation",
                str_c("non_supressed_county_total_aggregated_", Sys.Date(),".csv"),
                sep = "/"))
